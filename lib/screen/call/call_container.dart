// import 'package:CeeRoom/screen/call/participant_view.dart';
...
//   final Room meeting;
//
//   const OneToOneMeetingContainer({super.key, required this.meeting});
//
//   @override
...
//                 avatarBackground: Colors.black.withOpacity(0.7),
//                 stream: largeViewStream,
...
//                     child: ParticipantView(
//                       avatarTextSize: 30,
//                       avatarBackground: Colors.black.withOpacity(0.5),
//                       stream: smallViewStream,
